...
<b>20.05.2021</b> Состоялся релиз v.0.1 проекта <a href="https://github.com/thm-unix/devdiscover">devdiscover</a>, позволяющего обнаружить устройства в локальной сети в определенном диапазоне IP-адресов. Ее работа будет продемонстрирована в "Записках хакера" в теме обнаружения устройств (видео #8) наряду с nmap.<br><br>
