...
Проверить, выйдет ли у вас что-нибудь в ходе сегодняшней атаки, вы можете, введя желаемый адрес сайта здесь: 
...
<ul>
  <li><a href="https://kali.tools/?p=3870" target="_blank">Hackware: руководство по использованию Bettercap</a></li>
  <li><a href="https://kali.tools/?p=1600" target="_blank">Hackware: руководство по использованию Driftnet</a></li>
  <li><a href="https://kali.tools/?p=179" target="_blank">Hackware: руководство по использованию MITMf</a></li>
